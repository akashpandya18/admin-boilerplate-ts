            ...
            >
              <Dialog.Panel className='relative overflow-hidden text-left transition-all transform bg-white rounded-lg shadow-xl sm:my-8 sm:w-full sm:max-w-lg'>
                ...
                <div className='px-4 py-3 bg-gray-50 sm:flex sm:flex-row-reverse sm:px-6'>
                  <button
                    type='button'
                    className='inline-flex justify-center w-full px-6 py-2 text-base font-medium text-white bg-red-600 border border-transparent shadow-sm rounded-3xl hover:bg-red-700 focus:outline-none sm:ml-3 sm:w-auto sm:text-sm'
                    onClick={() => {
                      setOpen(false);
                      setDelete(false);
                    }}
